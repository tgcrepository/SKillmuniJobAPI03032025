...
// Type: m2ostnextservice.Controllers.getBriefListForAcademyController
...
using tbl_brief_tile_academic_mapping = m2ostnextservice.Models.tbl_brief_tile_academic_mapping;
...
namespace m2ostnextservice.Controllers
{
  public class getBriefListForAcademyController : ApiController
  {
        ...
        public getBriefListForAcademyController()
        {
        }

        public HttpResponseMessage Get(int UID, int OID, int AcadamyTileId)
        {
            getBriefListForAcademyController variable = null;
            getBriefListForAcademyController variable1 = null;
            getBriefListForAcademyController variable2 = null;
            ...
            foreach (tbl_brief_tile_academic_mapping ob in acadmap)
            {
                string briefTileCode = ob.BriefTileCode;
                ...
                foreach (tbl_brief_user_assignment tblBriefUserAssignment in check1)
                {
                    ...
                    if (tblBriefReadStatus.Where<tbl_brief_read_status>(Expression.Lambda<Func<tbl_brief_read_status, bool>>(Expression.AndAlso(Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(tbl_brief_read_status).GetMethod("get_id_brief_master").MethodHandle)), Expression.Property(Expression.Field(Expression.Constant(variable1, typeof(getBriefListForAcademyController)), FieldInfo.GetFieldFromHandle(typeof(getBriefListForAcademyController).GetField("item").FieldHandle)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(tbl_brief_user_assignment).GetMethod("get_id_brief_master").MethodHandle))), Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(tbl_brief_read_status).GetMethod("get_id_user").MethodHandle)), Expression.Property(Expression.Field(Expression.Constant(variable1, typeof(getBriefListForAcademyController)), FieldInfo.GetFieldFromHandle(typeof(getBriefListForAcademyController).GetField("item").FieldHandle)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(tbl_brief_user_assignment).GetMethod("get_id_user").MethodHandle)))), new ParameterExpression[] { parameterExpression })).FirstOrDefault<tbl_brief_read_status>() != null)
                    {
                        continue;
                    }
                ...
                foreach (BriefAPIResource briefAPIResource in list)
                {
                    ...
                    tbl_brief_log log = tblBriefLog.Where<tbl_brief_log>(Expression.Lambda<Func<tbl_brief_log, bool>>(Expression.AndAlso(Expression.AndAlso(Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(tbl_brief_log).GetMethod("get_attempt_no").MethodHandle)), Expression.Constant(1, typeof(int))), Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(tbl_brief_log).GetMethod("get_id_brief_master").MethodHandle)), Expression.Property(Expression.Field(Expression.Constant(variable2, typeof(getBriefListForAcademyController)), FieldInfo.GetFieldFromHandle(typeof(getBriefListForAcademyController).GetField("itm").FieldHandle)), (MethodInfo)MethodBase.GetMethodFromHandle(typeof(BriefAPIResource).GetMethod("get_id_brief_master").MethodHandle)))), Expression.Equal(Expression.Property(parameterExpression, (MethodInfo)MethodBase.GetMethodFromHandle(typeof(tbl_brief_log).GetMethod("get_id_user").MethodHandle)), Expression.Field(Expression.Field(Expression.Field(Expression.Constant(variable2, typeof(getBriefListForAcademyController)), FieldInfo.GetFieldFromHandle(typeof(getBriefListForAcademyController).GetField("CS$<>8__locals2").FieldHandle)), FieldInfo.GetFieldFromHandle(typeof(getBriefListForAcademyController).GetField("CS$<>8__locals1").FieldHandle)), FieldInfo.GetFieldFromHandle(typeof(getBriefListForAcademyController).GetField("UID").FieldHandle)))), new ParameterExpression[] { parameterExpression })).FirstOrDefault<tbl_brief_log>();
                    if (log == null)
                    {
