...
// Type: m2ostnextservice.Controllers.ForcePasswordChangeBriefController
...
namespace m2ostnextservice.Controllers
{
    ...
    public class ForcePasswordChangeBriefController : ApiController
  {
    public HttpResponseMessage Get(int uid, int oid, string password)
    {
      ...
      string str = new ChangePasswordLogic().ChangepasswordBrief(uid, oid, password);
      if (str == "You have successfully reset your password")
